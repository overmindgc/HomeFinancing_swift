...
class DatePickerDialog: UIView {
    ...
    fileprivate let kDatePickerDialogCornerRadius:              CGFloat = 5
...
//        self.dialogView!.layer.transform = CATransform3DMakeScale(1.3, 1.3, 1)
    ...
    func show(_ title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: Date = Date(), datePickerMode: UIDatePickerMode = .dateAndTime, callback: @escaping DatePickerCallback) {
        ...
        let locate = Locale(identifier: "zh_CN")
...
//        dialogContainer.layer.shadowPath = UIBezierPath(roundedRect: dialogContainer.bounds, cornerRadius: dialogContainer.layer.cornerRadius).CGPath
    ...
    fileprivate func addButtonsToView(_ container: UIView) {
        ...
        self.cancelButton.setTitleColor(appPayColor, for: UIControlState())
        ...
        self.doneButton.setTitleColor(appPayColor, for: UIControlState())
