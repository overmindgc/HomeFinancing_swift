...
class DatePickerDialog: UIView {
    ...
    private let kDatePickerDialogCornerRadius:              CGFloat = 5
...
//        self.dialogView!.layer.transform = CATransform3DMakeScale(1.3, 1.3, 1)
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: NSDate = NSDate(), datePickerMode: UIDatePickerMode = .DateAndTime, callback: DatePickerCallback) {
        ...
        let locate = NSLocale(localeIdentifier: "zh_CN")
        self.datePicker.locale = locate
...
//        dialogContainer.layer.borderColor = appPayColor.CGColor
...
//        dialogContainer.layer.shadowPath = UIBezierPath(roundedRect: dialogContainer.bounds, cornerRadius: dialogContainer.layer.cornerRadius).CGPath
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.setTitleColor(appPayColor, forState: UIControlState.Normal)
        ...
        self.doneButton.setTitleColor(appPayColor, forState: UIControlState.Normal)
